...
def plot_all_knn_vs_maddpg_rel(lst_of_rew_paths):
    ...
    for i in range(0,len(lst_of_rew_paths),2):
        ...
        plt.plot(episodes[1:], mean_rew2[1:], color=cl[i+1], label=lst_of_rew_paths[i+1].split("/")[-1], linewidth=0.6)
    plt.xlabel('# episodes')
    plt.ylabel('mean episode reward')
...
plot_all_knn_vs_maddpg_rel(["src/net_configs/simplespread/MADDPG_N3","src/net_configs/simplespread/MADDPG_N3_K2","src/net_configs/simplespread/MADDPG_N5","src/net_configs/simplespread/MADDPG_N5_K2","src/net_configs/simplespread/MADDPG_N7","src/net_configs/simplespread/MADDPG_N7_K2","src/net_configs/simplespread/MADDPG_N9","src/net_configs/simplespread/MADDPG_N9_K2"])
